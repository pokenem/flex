            ...
            <div className="terms-container p-2">
                ...
                <section className="u-mb-1">
                    ...
                    <p className="text-base font-light">
                        Tieto všeobecné obchodné podmienky upravujú používanie tejto webovej stránky a podmienky
                        poskytovania
                        našich služieb.
                ...
                <section className="u-mb-1">
                    ...
                    <p className="text-base font-light">
                        ...
                        Vyhradzujeme si právo kedykoľvek zmeniť alebo pozastaviť poskytovanie služieb bez predchádzajúceho
                        upozornenia.
                    </p>
                </section>
                ...
                <section className="u-mb-1">
                    ...
                    <p className="text-base font-light">
                        Nie sme zodpovední za akékoľvek priame alebo nepriame škody vzniknuté používaním tejto stránky alebo
                        našich služieb.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-base font-light">
                        V prípade otázok nás môžete kontaktovať prostredníctvom kontaktného formulára alebo emailom na
                        info@example.sk.
                    </p>
                </section>
            </div>
